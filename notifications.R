...
Starting from a budget you set, this web app allows you to derive the full range of plausible emission paths that meet that budget. A brief description of the RM Scenario Types used can be found <a href=”https://www.klima-retten.info/Downloads/RM-Scenario-Types_short.pdf”>here</a>. A corresponding more detailed Excel tool can be found <a href=https://doi.org/10.5281/zenodo.4568839 target='_blank'>here</a>.<br><br>
...
We recommend the EU's 'Emissions Database for Global Atmospheric Research' (<a href='https://edgar.jrc.ec.europa..info' taget='_blank'>EDGAR</a>) and the <a href='https://www.globalcarbonproject.org' target='_blank'>Global Carbon Project</a>. On the EU, we refer to the European Environment Agency (<a href='https://www.eea.europa..info' taget='_blank'>EEA</a>).<br><br>
