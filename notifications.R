...
output$title <- renderUI({
  ...
  output[[3]] <- hidden(div(class = "info-box", style = "left:330px; width:500px;", id = "info_general", 
                            HTML("
The Extended Smooth Pathway Model (ESPM) makes it possible to identify emission paths that adhere to a predefined budget. This allows Paris-compatible emission targets to be identified. A brief background paper on the ESPM can be found <a href='https://www.klima-retten.info/PDF/ESPM_Background.pdf' target='_blank'>here</a>.<br><br>
Starting from a budget you set, this tool allows you to derive the full range of plausible emission paths that meet that budget. A brief description of the RM Scenario Types used can be found <a href='https://www.klima-retten.info/Downloads/RM-Scenario-Types_short.pdf'>here</a>.<br><br>
Here we offer the possibility to calculate national CO2 budgets for all countries of the world with a web app: <a href= 'http://national-budgets.climate-calculator.info' target='_blank'>http://national-budgets.climate-calculator</a>.<br><br>
<a href=https://doi.org/10.5281/zenodo.4568839 target='_blank'>Here</a> you will find the corresponding more detailed Excel tool to this web app.<br><br>
...
Our main page: <a href='https://www.save-the-climate.info/' target='_blank'>www.save-the-climate.info</a>.<br><br>
...
<b>Starting rate of change RM 3 – 5</b><br><br>
The rate of change for 2020 is basically an input value in the RM Scenario Types RM 3 - 5, which serves as a starting value for the determination of the following rates of change. However, due to the temporary corona effect in 2020, it does not make sense to use the actual value for 2020. A normalised value should be used.<br><br>
<b>Start rate of change in the web app</b><br><br>
In this web app, the change in emissions from 2018 to 2019 is generally used as the normalised starting change rate.<br><br>
However, the iterative solution procedure in the web app cannot process a positive starting change rate. Therefore, if emissions increase from 2018 to 2019, 0% is set as the starting rate of change for 2020.<br><br>
...
Our web app <a href='http://national-budgets.climate-calculator.info' target='_blank'>http://national-budgets.climate-calculator.info</a> provides the corresponding data for all countries in the world.<br><br>
...
However, it should be noted that the overshoot amounts can also lead to dangerous tipping points in the climate system being exceeded. Also, it should be pointed out that the costs of actively capturing CO2 are still unclear and that there are major methodological and substantive problems in quantifying sinks and questions regarding their sustainable value.<br><br>
