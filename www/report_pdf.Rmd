...
header-includes:
 ...
 - \pagestyle{fancy}
 - \fancyhead[]{}
 - \fancyfoot[L]{\footnotesize Smooth emission paths - `r format(Sys.time(), "%d %b %Y")`}
 - \fancyfoot[C]{}
...
plot1 <- params$result %>%
  ...
  mutate(change = paste0(as.character(round((1 - emissions / params$reference_year_emissions) * -100, 1)), "%"),
